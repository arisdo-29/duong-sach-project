...
async function main() {
  ...
  // ------------------------------------------------------------------
  // 5. Di sản (10 bản ghi, giữ nguyên slug cũ – QR đã in)
  // ------------------------------------------------------------------
  ...
  const heritagesData = [
    {
      ...
      content_vi:
        'Được xây dựng từ năm 1886 đến 1891 theo đồ án của kiến trúc sư Alfred Foulhoux và thiết kế kết cấu vòm kim loại của Gustave Eiffel. Công trình mang phong cách Phục Hưng kết hợp hài hòa với các hoa văn trang trí Đông Dương, nằm ngay đầu Đường Sách Nguyễn Văn Bình.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Nhà thờ chính tòa Đức Bà Sài Gòn là một kiệt tác kiến trúc cổ kính với toàn bộ gạch xây dựng được nhập khẩu từ Marseille (Pháp). Công trình khởi công năm 1877 và khánh thành năm 1880, là biểu tượng tôn giáo và lịch sử tiêu biểu của thành phố.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Di tích quốc gia đặc biệt ghi dấu mốc son lịch sử ngày 30/4/1975 thống nhất đất nước. Công trình do Kiến trúc sư Ngô Viết Thụ thiết kế, kết hợp hài hòa giữa kiến trúc hiện đại phương Tây và thuật phong thủy, triết lý phương Đông.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Tòa nhà ban đầu là trụ sở của Công ty Vận tải Hoàng gia Pháp (Messageries Impériales), xây dựng từ năm 1863. Đây là nơi người thanh niên Nguyễn Tất Thành lên con tàu Amiral Latouche-Tréville ra đi tìm đường cứu nước vào ngày 5/6/1911.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Tọa lạc tại số 65 Lý Tự Trọng, công trình nguyên là Dinh Gia Long, được xây dựng từ năm 1885 đến 1890 theo phong cách kiến trúc Tân Cổ Điển Pháp bởi kiến trúc sư Alfred Foulhoux.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Được thành lập năm 1929, ban đầu có tên là Bảo tàng Blanchard de la Brosse, mang phong cách kiến trúc "Đông Dương cách tân" với mái ngói cổ truyền nhiều tầng độc đáo trong khuôn viên Thảo Cầm Viên.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Khánh thành vào năm 1900 mang phong cách Flamboyant Gothic và Phục Hưng Pháp, nhà hát là trung tâm biểu diễn nghệ thuật danh tiếng bậc nhất miền Nam.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Khởi công xây dựng từ năm 1912 và hoàn thành năm 1914. Tháp đồng hồ ở cửa Nam của chợ là một trong những hình ảnh đặc trưng gắn liền với lịch sử thương mại của Sài Gòn.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Được xây dựng từ năm 1898 đến 1909 do kiến trúc sư Femand Gardès thiết kế mô phỏng theo kiểu tòa thị chính ở Paris với tháp chuông nhọn và tượng điêu khắc tinh xảo.',
      content_en:
    ...
    },
    {
      ...
      content_vi:
        'Tòa nhà nguyên là dinh thự tráng lệ của doanh nhân Hứa Bổn Hòa (Chú Hỏa), kết hợp hài hòa giữa trường phái mỹ thuật Baroque châu Âu và kiến trúc cung đình phương Đông.',
      content_en:
  ...
  for (const [index, h] of heritagesData.entries()) {
    const item = await prisma.item.create({
      data: {
        ...
        Name: h.name_vi,
        NameEng: h.name_en,
        Content: `<p>${h.content_vi}</p>`,
        ContentEng: `<p>${h.content_en}</p>`,
        Slug: h.slug,
        DisplayOrder: index,
        AttributeMappings: {
          create: [{ ItemAttributeId: attrSource.Id, Value: h.source }],
        },
        PictureMappings: {
          create: [
            {
              IsMainPicture: true,
              DisplayOrder: 0,
              Picture: { create: { Url: h.image_url } },
            },
          ],
        },
      },
    });
    createdHeritages[h.slug] = item;
  }
  ...
  console.log('   2 cơ sở · 4 loại nội dung · 7 thuộc tính · 10 di sản · 7 gian hàng');
