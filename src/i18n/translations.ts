...
export const translations = {
  ...
  eventCalendarLabel: { vi: 'Lịch sự kiện', en: 'Event calendar' },
  previousMonth: { vi: 'Tháng trước', en: 'Previous month' },
  nextMonth: { vi: 'Tháng sau', en: 'Next month' },
  upcomingEventsTitle: { vi: 'Những sự kiện sắp tới', en: 'Upcoming events' },
  upcomingEventsSubtitle: { vi: 'Khám phá các hoạt động nổi bật tại Đường sách.', en: 'Discover featured activities at the book street.' },
